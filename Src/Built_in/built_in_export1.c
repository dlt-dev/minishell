 ...
 * de l'affectation etait mauvais et on le signale via le message "not_a_valid_identifier". 
 * - si le retour de @param is_an_affecation est IS_NOT, ce n'est pas une affectation,
 * malgre un bon nom, il n'y a pas de =. On ignore si;ple;ent
 * - si le retour de @param is_an_affecation est IS, c'est une affectation et une 
