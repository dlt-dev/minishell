...
// utils_lst2.c
void			node_exchange(t_list **lst, t_list *curr_node,
					t_list *prev_node, t_list *new_node);
void			insert_after_node(t_list *curr_node, t_list *new_node);
void			del_one_relink(t_list **lst, t_list *curr_node,
					t_list *prev_node);
...
void		switch_last_node(t_list *curr_node, t_list *prev_node, t_list *new_node);
void		switch_middle_node(t_list *curr_node, t_list *prev_node, t_list *new_node);
...
void			del_one_valist(t_valist **lst, t_valist *curr_node,
					t_valist *prev_node);
